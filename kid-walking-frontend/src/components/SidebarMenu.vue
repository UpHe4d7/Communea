...
<template>
  <div :class="['sidebar', { 'dimmed': isDimmed }]">
    ...
    <ul class="menu">
      ...
      <li><router-link to="/parent-application">My Application</router-link></li>
      <li><router-link to="/mypost">My post</router-link></li>
      <li><router-link to="/agreement">My Agreement</router-link></li>
    </ul>
